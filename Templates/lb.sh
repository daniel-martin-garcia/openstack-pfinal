...
openstack security group rule create --protocol tcp --dst-port 80:8080 lbaasv2
...
neutron lbaas-member-create --name lb-member-01 --subnet subnet1 --address $IP_VM1 --protocol-port 8080 lb-http-pool
neutron lbaas-member-create --name lb-member-02 --subnet subnet1 --address $IP_VM2 --protocol-port 8080 lb-http-pool
neutron lbaas-member-create --name lb-member-03 --subnet subnet1 --address $IP_VM3 --protocol-port 8080 lb-http-pool