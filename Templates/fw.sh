...
openstack firewall group create --ingress-firewall-policy fw-policy --egress-firewall-policy 4335a308-ea39-4438-bcff-81ec63a63b4b --port $PORT_ID --name fw-group
